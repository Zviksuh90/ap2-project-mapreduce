...
public class ScoreDriver implements InterfaceDriver {
	private Path output;
	private static final String JOBNAME = "score_driver_data";
	/*************************************************************************
	 * function name: doJob 
	...
	public void doJob(String outPath,String outputPath) throws Exception {
		...
		job.setReducerClass(MessageScoreReducer.class);
		...
		output = new Path(outPath + "/"+JOBNAME);
